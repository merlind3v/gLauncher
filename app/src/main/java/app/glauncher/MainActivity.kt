...
import app.glauncher.databinding.ActivityMainBinding
import app.glauncher.helper.getColorFromAttr
import app.glauncher.helper.hasBeenDays
import app.glauncher.helper.hasBeenHours
import app.glauncher.helper.hasBeenMinutes
import app.glauncher.helper.isDarkThemeOn
import app.glauncher.helper.isDaySince
import app.glauncher.helper.isDefaultLauncher
...
import app.glauncher.helper.resetLauncherViaFakeActivity
import app.glauncher.helper.setPlainWallpaper
import app.glauncher.helper.shareApp
import app.glauncher.helper.showLauncherSelector
...
//    }
    ...
    private fun backToHomeScreen() {
        if (viewModel.isPrivateSpaceToggling || viewModel.isAppLockActivityShowing) return
        binding.messageLayout.visibility = View.GONE
        if (navController.currentDestination?.id != R.id.mainFragment)
